...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* pointProcessorI , const pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
    ...
    // Filtering (Voxel, Region and Roof cropping)
    ...
    // Custom Segmentation into road and obstacle
    std::pair<pcl::PointCloud<pcl::PointXYZI>::Ptr, pcl::PointCloud<pcl::PointXYZI>::Ptr> segmentCloud = pointProcessorI->ransacPlane(filterCloud, 25, 0.3);
    
    //renderPointCloud(viewer, segmentCloud.first, "obstCloud");
    renderPointCloud(viewer, segmentCloud.second, "planeCloud", Color(0,1,0));

    //PCL built-in Segmentation into road and obstacle
...
int main (int argc, char** argv)
{
    ...
    while (!viewer->wasStopped ())
    {
        ...
        // load pcd and run obstacle detecion process
